...
class Widget(QMainWindow, Ui_MainWindow):
    ...
    def sender(self, com, num):
        ...
        try:
            ...
            # self.message('is not connected')
            pass

    def message(self, mes):
        # s = str(self.console_textEdit.toHtml())
        pass
        # self.console_textEdit.setHtml(s + "<p style=color:white;>" + mes + "</p>")
        # self.console_textEdit.verticalScrollBar().setValue(
        #   self.console_textEdit.verticalScrollBar().maximum())
    ...
    def start_animation_1(self):
        ...
        for i in xm:
            ...
            try:
                print(float(p[n + 1]) - float(p[n]))
                time.sleep(float(p[n + 1]) - float(p[n]))
            except:
                print('end of list')
            n += 1
    ...
    def show_3d(self):
        ...
        while True:
            ...
            try:
                ...
                # col = [(0, 1, 0), (0.68, 1, 0.18), (1, 0.84, 0), (1, 0, 1), (0, 0, 1), (0.80, 0.36, 0.36),
                #       (0.5, 0.5, 0.5), (0.94, 0.5, 0.5)]
